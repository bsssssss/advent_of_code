...
- FOR EACH lines
  ...
  - first pass
    * FOR EACH character in line minus one character
      * find maximum
      * append bank_joltage string with result
  - second pass
    * FOR EACH character in line starting from position of first pass result
      * find maximum
      * append bank_joltage string with result
  - ACCUM result with result string 

- OUTPUT total_joltage
